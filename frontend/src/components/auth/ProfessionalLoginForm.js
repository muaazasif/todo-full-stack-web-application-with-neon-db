// frontend/src/components/auth/ProfessionalLoginForm.js
...
const ProfessionalLoginForm = ({ onLogin }) => {
      ...
      <div className="max-w-md w-full space-y-8 bg-white/90 backdrop-blur-lg p-10 rounded-3xl shadow-2xl border border-white/50 transform transition-all duration-500 hover:shadow-3xl">
        <div className="text-center animate-fade-in-down">
          ...
          <p className="mt-3 text-lg text-gray-600 transition-colors duration-300 hover:text-indigo-700">
            ...
            <Link href="/auth/signup" className="font-bold text-indigo-600 hover:text-indigo-800 underline decoration-indigo-600/50 transition-all duration-300">
              Need an account?
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between animate-fade-in-up delay-200">
            ...
            <div className="text-sm">
              <a href="#" className="font-medium text-indigo-600 hover:text-indigo-800 font-semibold underline decoration-indigo-600/50 transition-all duration-300">
